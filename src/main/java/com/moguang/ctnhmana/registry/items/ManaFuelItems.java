...
/**
 * 魔力燃料棒类物品集中注册，风格与 {@link com.moguang.ctnhmana.registry.CMItems} 一致。
 */
public final class ManaFuelItems {
    ...
    /** 崩解态：仅 {@link ComponentItem}，无燃料棒机制，作普通材料；供 {@link IManaFuelStick#disintegration} 引用。 */
    ...
    public static void registerItem() {
        SPARK_STICK_DISINTEGRATED = REGISTRATE
                ...
                .lang("Spark Stick (Disintegrated)")
        ...
        ADVANCED_SPARK_STICK_DISINTEGRATED = REGISTRATE
                ...
                .lang("Advanced Spark Stick (Disintegrated)")
                .tag(CMTags.ELEMENT_FIRE)
                .register();
        TERRA_STICK_DISINTEGRATED = REGISTRATE
                ...
                .lang("Terra Stick (Disintegrated)")
        ...
        MIXED_WILL_STICK_DISINTEGRATED = REGISTRATE
                ...
                .lang("Aggregated Will Fuel Stick (Disintegrated)")
        ...
        MIXED_WILL_STICK = REGISTRATE
                .item("mixed_will_stick",
                        p -> new IManaFuelStick(p, 12, 5, 12500, MIXED_WILL_STICK_DISINTEGRATED.get()))
                .cnlang("聚合意志燃料棒")
                .model(manasparkModel())
