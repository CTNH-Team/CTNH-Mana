...
public class ZenithMachine {
    ...
    public final static MultiblockMachineDefinition ZENITH_CUTTER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .aisle("BBBGCCC", "DHHIHHD", "DJJIJJD", "DJJIJJD", "DHHIHHD", "CCCIEEE", "DHHIHHD", "DKKIKKD", "DLLILLD", "DKKIKKD", "DHHIHHD", "EEEIFFF", "DHHIHHD", "DKKIKKD", "DLLILLD", "DKKIKKD", "DHHIHHD", "FFFMBBB")
                    .aisle("BBBGCCC", "DHHIHHD", "DJJIJJD", "DJJIJJD", "DHHIHHD", "CCCIEEE", "DHHIHHD", "DKKIKKD", "DLLILLD", "DKKIKKD", "DHHIHHD", "EEEIFFF", "DHHIHHD", "DKKIKKD", "DLLILLD", "DKKIKKD", "DHHIHHD", "FFFMBBB")
                    .aisle("AGGAGGA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AIIAIIA", "AMMNMMA")
                    .aisle("FFFGEEE", "DHHIHHD", "DJJIJJD", "DJJIJJD", "DHHIHHD", "BBBIFFF", "DHHIHHD", "DKKIKKD", "DLLILLD", "DKKIKKD", "DHHIHHD", "CCCIBBB", "DHHIHHD", "DKKIKKD", "DLLILLD", "DKKIKKD", "DHHIHHD", "EEEMCCC")
                    .aisle("FFFGEEE", "DHHIHHD", "DJJIJJD", "DJJIJJD", "DHHIHHD", "BBBIFFF", "DHHIHHD", "DKKIKKD", "DLLILLD", "DKKIKKD", "DHHIHHD", "CCCIBBB", "DHHIHHD", "DKKIKKD", "DLLILLD", "DKKIKKD", "DHHIHHD", "EEEMCCC")
    ...
    public final static MultiblockMachineDefinition ZENITH_ELECTROLYZER = REGISTRATE
            ...
            .recipeModifiers(BaseManaMachine::recipeModifier,
                    GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.NON_PERFECT_OVERCLOCK_SUBTICK))
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("A################", "######BBBBB######", "###BBBCCDEEBBB###", "##BCCCFCDEFEEEB##", "##BCFBBCDEBBFEB##", "##BCBCCCDEEEBEB##", "#BCFBCDDDDDEBFEB#", "BBCCCCDDDDDEEEEBB", "BDDDDDDDDDDDDDDDB", "BBGGGGDDDDDHHHHBB", "#BGFBGDDDDDHBFHB#", "##BGBGGGDHHHBHB##", "##BGFBBGDHBBFHB##", "##BGGGFGDHFHHHB##", "###BBBGGDHHBBB###", "######BBDBB######", "#######BBB#######")
                    .aisle("######BBBBB######", "###BBB##I##BBB###", "##B#####I#####B##", "#B######I######B#", "#B######I######B#", "#B######I######B#", "B######I#I######B", "B#####I###I#####B", "DIIIII#####IIIIID", "B#####I###I#####B", "B######I#I######B", "#B######I######B#", "#B######I######B#", "#B######I######B#", "##B#####I#####B##", "###BBB##I##BBB###", "######BJJJB######")
                    .aisle("######BBBBB######", "###DDD#IFI#DDD###", "##D####IFI####D##", "#D#####IFI#####D#", "#D#####IFI#####D#", "#D#####IFI#####D#", "D#####IFKFI#####D", "DIIIIIF#K#FIIIIID", "#FFFFFKKLKKFFFFF#", "DIIIIIF#K#FIIIIID", "D#####IFKFI#####D", "#D#####IFI#####D#", "#D#####IFI#####D#", "#D#####IFI#####D#", "##D####IFI####D##", "###DDD#IFI#DDD###", "######BJMJB######")
                    .aisle("######BBBBB######", "###BBB##I##BBB###", "##B#####I#####B##", "#B######I######B#", "#B######I######B#", "#B######I######B#", "B######I#I######B", "B#####I###I#####B", "DIIIII#####IIIIID", "B#####I###I#####B", "B######I#I######B", "#B######I######B#", "#B######I######B#", "#B######I######B#", "##B#####I#####B##", "###BBB##I##BBB###", "######BJJJB######")
                    .aisle("#################", "######BB#BB######", "###BBBHHDGGBBB###", "##BHHHFHDGFGGGB##", "##BHFBBHDGBBFGB##", "##BHBHHHDGGGBGB##", "#BHFBHDDDDDGBFGB#", "BBHHHHDDDDDGGGGB#", "BDDDDDDDDDDDDDDD#", "BBEEEEDD@DDCCCCB#", "#BEFBEDDDDDCBFCB#", "##BEBEEEDCCCBCB##", "##BEFBBEDCBBFCB##", "##BEEEFEDCFCCCB##", "###BBBEEDCCBBB###", "######BBDBB######", "#######BBB######A")
                    .where("@", Predicates.controller(Predicates.blocks(definition.get())))
...
//            .register();
    public final static MultiblockMachineDefinition ZENITH_CIRCUIT_ASSEMBLER = REGISTRATE
            ...
            .recipeModifiers(BaseManaMachine::recipeModifier,
                    GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic.NON_PERFECT_OVERCLOCK_SUBTICK))
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("A########", "#########", "#########", "##BBBBB##", "##BCCCB##", "##BCDCB##", "##BCCCB##", "##BBBBB##", "#########", "#########", "#########")
                    .aisle("#########", "#########", "#EEFFFGG#", "#E#####G#", "#F#####F#", "#F#####F#", "#F#####F#", "#H#####I#", "#HHFFFII#", "#########", "#########")
                    .aisle("#########", "##BBBBB##", "#E#####G#", "B#######B", "B###G###B", "B##JDJ##B", "B###H###B", "B#######B", "#H#####I#", "##BBBBB##", "#########")
                    .aisle("###BBB###", "##BBBBB##", "#F#####F#", "B###G###B", "C##KGK##C", "C#JJDJJ#C", "C##KHK##C", "B###H###B", "#F#####F#", "##B###B##", "###LLL###")
                    .aisle("###BMB###", "##BBNBB##", "#F#####F#", "B##IDE##B", "C#IIDEE#C", "D#DDDDD#D", "C#EEDII#C", "B##EDI##B", "#F#####F#", "##B#D#B##", "###LOL###")
                    .aisle("###BBB###", "##BBBBB##", "#F#####F#", "B###H###B", "C##KHK##C", "C#JJDJJ#C", "C##KGK##C", "B###G###B", "#F#####F#", "##B###B##", "###LLL###")
                    .aisle("#########", "##BBBBB##", "#I#####H#", "B#######B", "B###H###B", "B##JDJ##B", "B###G###B", "B#######B", "#G#####E#", "##BBBBB##", "#########")
                    .aisle("#########", "#########", "#IIFFFHH#", "#I#####H#", "#F#####F#", "#F#####F#", "#F#####F#", "#G#####E#", "#GGFFFEE#", "#########", "#########")
                    .aisle("#########", "#########", "#########", "##BBBBB##", "##BBBBB##", "##BB@BB##", "##BBBBB##", "##BBBBB##", "#########", "#########", "########A")
                    .where("@", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("A", Predicates.any())
    ...
    public final static MultiblockMachineDefinition ZENITH_EXTRUDER = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("A#BBBBB#", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########")
                    .aisle("#BBBBBBB", "##CBDBE#", "###DFD##", "###BDB##", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "###BBB##")
                    .aisle("BBBBBBBB", "#CC#G#EE", "##C#F#E#", "##C###E#", "##CBDBE#", "##CCGEE#", "########", "########", "########", "########", "########", "########", "########", "########", "########", "###BBB##", "##BDDDB#")
                    .aisle("BBBBBBBB", "#B##G##B", "#D##F##D", "#B#####B", "##B###B#", "##C###E#", "###B#B##", "###B#B##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "##BDDDB#", "#BDIIIDB")
                    .aisle("BBBBBBBB", "#DGGGGGD", "#FFFGFFF", "#D##G##D", "##D#G#D#", "##G#G#G#", "###HGH##", "###HGH##", "###HGH##", "###HGH##", "###HGH##", "###HGH##", "###HGH##", "###HGH##", "###HGH##", "##BDGDB#", "#BDIJIDB")
                    .aisle("BBBBBBBB", "#B##G##B", "#D##F##D", "#B#####B", "##B###B#", "##K###L#", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "###BHB##", "##BDDDB#", "#BDIIIDB")
                    .aisle("BBBBBBBB", "#KK#G#LL", "##K#F#L#", "##K###L#", "##KBDBL#", "##KKGLL#", "########", "########", "########", "########", "########", "########", "########", "########", "########", "###BBB##", "##BDDDB#")
                    .aisle("#BBBBBBB", "##KBDBL#", "###DFD##", "###BDB##", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "########", "###BBB#A")
    ...
    public final static MultiblockMachineDefinition ZENITH_DISTILLATION = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("A##BBB###", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "###BBB###")
                    .aisle("##BBBBB##", "##BCDCB##", "##CDDDC##", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "##CEEEC##", "##BCECB##", "##BBBBB##")
                    .aisle("#BBBBBBB#", "#BCBDBCB#", "#CBBBBBC#", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "#CBBBBBC#", "#BCBEBCB#", "#BBBBBBB#")
                    .aisle("BBBBBBBBB", "#CBBDBBC#", "#GBHHHBI#", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "#IBHHHBG#", "#CBBEBBC#", "BBBJJJBBB")
                    .aisle("BBBBBBBBB", "#GGGKIII#", "#GBHHHBI#", "##F#H#F##", "##F#H#F##", "##F#H#F##", "##F#H#F##", "##F#H#F##", "##F#H#F##", "##F#H#F##", "##F#H#F##", "##F#H#F##", "##F#H#F##", "##F#H#F##", "#IBHHHBG#", "#IIIKGGG#", "BBBJLJBBB")
                    .aisle("BBBBBBBBB", "#CBBEBBC#", "#GBHHHBI#", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "##F###F##", "#IBHHHBG#", "#CBBDBBC#", "BBBJJJBBB")
                    .aisle("#BBBBBBB#", "#BCBEBCB#", "#CBBBBBC#", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "##BFFFB##", "#CBBBBBC#", "#BCBDBCB#", "#BBBBBBB#")
                    .aisle("##BBBBB##", "##BCECB##", "##CEEEC##", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "##CDDDC##", "##BCDCB##", "##BBBBB##")
                    .aisle("###B@B###", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "#########", "###BBB##A")
                    .where("@", Predicates.controller(Predicates.blocks(definition.get())))
                    .where("E", Predicates.blocks(CMBlocks.ELEMENTIUM_CASING.get()))
                    .where("B", Predicates.blocks(CMBlocks.ZENITH_CASING_BLOCK.get())
