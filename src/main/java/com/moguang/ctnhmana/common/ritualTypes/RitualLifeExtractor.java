...
public class RitualLifeExtractor extends Ritual {
    ...
    public void performRitual(IMasterRitualStone MasterRitualStone) {
        ...
        for (AlfPixie pixie:pixielList)
        {
            ...
            {
                gems=ChemicalHelper.get(gemChipped, CMMaterials.Psionic_Medulla, min_num+(int) (Math.random()*max_num));
            }
            else if(Math.random()<=flawed)
            {
                gems=ChemicalHelper.get(gemFlawed, CMMaterials.Psionic_Medulla, min_num+(int) (Math.random()*max_num));
            }
            else
            {
