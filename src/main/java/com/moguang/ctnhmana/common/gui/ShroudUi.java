...
public class ShroudUi implements IFancyUIProvider {
    ...
    public Widget createMainPage(FancyMachineUIWidget fancyMachineUIWidget) {
        ...
        var center_ring=new ImageWidget((275-92)/2/2*3,(275-92)/2/2*3,circle_length,circle_length,CMGuiTextures.SHROUND_RING);
        var quadrant_neutral_A=new ArcButtonWidget(0,y_position,width,height,CMGuiTextures.QUADRANT_NEUTRAL,clickData -> {
            a=true;
        });
        ...
        var quadrant_neutral_B=new ArcButtonWidget(0,y_position,width,height,left_texture.rotate(45), clickData -> {
            a=true;
        });
        ...
        var quadrant_neutral_C=new ArcButtonWidget(0,y_position,width,height,CMGuiTextures.QUADRANT_NEUTRAL.copy().rotate(90), clickData -> {
            a=true;
        });
        ...
        var quadrant_neutral_D=new ArcButtonWidget(0,y_position,width,height,CMGuiTextures.QUADRANT_NEUTRAL.copy().rotate(180-45),clickData -> {
            a=true;
        });
        ...
        var delve_window=new ImageWidget(100,20,800-100-width,140,CMGuiTextures.DELVE_WINDOW.setColor(Color.GREEN.getRGB()));

        configgroup.addWidgets(delve_window);
        centergroup.addWidgets(center_ring,quadrant_neutral_A,quadrant_neutral_B,quadrant_neutral_C,quadrant_neutral_D,configgroup);
