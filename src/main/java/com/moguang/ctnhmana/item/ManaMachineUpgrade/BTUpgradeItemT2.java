...
public class BTUpgradeItemT2 extends ManaMachineUpgradeItem {

    public BTUpgradeItemT2(Properties properties) {
        super(properties, "BT", BT_UPDATE_NAME_T2);
    }
    ...
    public BaseManaMachine.MachineMetric calculateUpgrade(BaseManaMachine.MachineMetric metric, GTRecipe recipe,
        ...
        metric.speed += Math.min(0.5, true_parallel * 0.02);
    ...
    public BaseManaMachine.MachineMetric calculateNormalUpgrade(BaseManaMachine.MachineMetric metric,
        ...
        metric.parallel += Math.min(64, (hatch.getBTMana() / 25000 + hatch.getmaxBTMana() / 200000));
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents,
        ...
        super.appendHoverText(stack, level, itemTooltipsAdd(botaniacoreLang_t2, tooltipComponents), isAdvanced); // 调用父类方法以处理原版提示信息
    }
    ...
    @CN({
            "偏向于植物魔法与魔力的升级",
            "机器获得：",
            "魔力凝聚仓每存有2.5W魔力，每存有20W魔力存储上限，就获得一点并行(最高64)",
            "运行时的每一并行提供§a+2%§r机器工作速度(最高50%)",
    ...
    public static Lang[] botaniacoreLang_t2;
}
