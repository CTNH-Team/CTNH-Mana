...
public class SparkManaHatch extends ManaHatch {
    ...
    public SparkManaHatch(IMachineBlockEntity holder, long maxMana, long maxLP, int maxBTMana, int capacity, int BTMANA_CONVERT_RATE, int LP_CONVERT_RATE, int FLUID_MANA_CONVERT_RATE) {
        super(holder, maxMana, maxLP, maxBTMana, capacity, BTMANA_CONVERT_RATE, LP_CONVERT_RATE, FLUID_MANA_CONVERT_RATE);
    ...
    public SparkManaHatch(IMachineBlockEntity holder, long maxMana, long maxLP, int maxBTMana, int capacity, int BTMANA_CONVERT_RATE, int LP_CONVERT_RATE, int FLUID_MANA_CONVERT_RATE,int sparkConvertSpeed) {
        super(holder, maxMana, maxLP, maxBTMana, capacity, BTMANA_CONVERT_RATE, LP_CONVERT_RATE, FLUID_MANA_CONVERT_RATE);
        fluidTank= new NotifiableFluidTank(this,1,capacity, IO.NONE,IO.BOTH);
        inventory = new NotifiableItemStackHandler(this, 1, IO.NONE,IO.BOTH);
        var centerPos=this.getPos();
    ...
    public SparkManaHatch(IMachineBlockEntity holder, long maxMana, long maxLP, int maxBTMana, int capacity,int sparkConvertSpeed) {
        super(holder, maxMana, maxLP, maxBTMana, capacity);
        fluidTank= new NotifiableFluidTank(this,1,capacity,IO.NONE,IO.BOTH);
        inventory = new NotifiableItemStackHandler(this, 1, IO.NONE,IO.BOTH);
        this.sparkConvertSpeed=sparkConvertSpeed;
    ...
    public Widget createUIWidget() {
        ...
        var speed_progress2=(new ProgressWidget(this.get_MP, 176-4-5-18, 124/2-52, 24, 112, new ProgressTexture(CMGuiTextures.PROGRESS_BAR_BT_MANA_HATCH_EMPTY,CMGuiTextures.PROGRESS_BAR_BT_MANA_HATCH_DYNAMIC).setFillDirection(ProgressTexture.FillDirection.DOWN_TO_UP)
