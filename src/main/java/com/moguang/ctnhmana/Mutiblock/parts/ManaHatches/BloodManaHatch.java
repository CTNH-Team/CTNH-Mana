...
public class BloodManaHatch extends ManaHatch implements IDistinctPart, IMachineModifyDrops{
    ...
    public Widget createUIWidget() {
        ...
        var speed_progress2=(new ProgressWidget(this.get_MP, 176 - 24 - 4-4, 124/2-26, 24, 112, new ProgressTexture(CMGuiTextures.PROGRESS_BAR_BM_MANA_HATCH_EMPTY,CMGuiTextures.PROGRESS_BAR_BM_MANA_HATCH_DYNAMIC).setFillDirection(ProgressTexture.FillDirection.DOWN_TO_UP)
