...
public final class SpireBigMath {
    ...
    /**
     * 与 {@link com.moguang.ctnhmana.Mutiblock.SpireMath#mulLongDoubleCap} 同类，但作用于 BigInteger，
     * 容量不再受 int 限制。
     */
     ...
     * 天顶尖塔应传入与 {@link com.moguang.ctnhmana.common.blockentity.machine.MysticSpireBlockEntity#getTrueManaCapBig()}
