...
public class BotaniaIngredients {
    ...
    public static Ingredient RED = Ingredient.of(TagKey.create(Registries.ITEM, ModUtils.BotaniaRL("petals/red")));
    public static Ingredient BLACK = Ingredient.of(TagKey.create(Registries.ITEM, ModUtils.BotaniaRL("petals/black")));
    public static Ingredient runeWater = Ingredient.of(BotaniaItems.runeWater);
    public static Ingredient runeFire = Ingredient.of(BotaniaItems.runeFire);
    public static Ingredient runeEarth = Ingredient.of(BotaniaItems.runeEarth);
    public static Ingredient runeAir = Ingredient.of(BotaniaItems.runeAir);
    public static Ingredient runeSpring = Ingredient.of(BotaniaItems.runeSpring);
    public static Ingredient runeSummer = Ingredient.of(BotaniaItems.runeSummer);
    public static Ingredient runeAutumn = Ingredient.of(BotaniaItems.runeAutumn);
    public static Ingredient runeWinter = Ingredient.of(BotaniaItems.runeWinter);
    public static Ingredient runeMana = Ingredient.of(BotaniaItems.runeMana);
    public static Ingredient runeLust = Ingredient.of(BotaniaItems.runeLust);
    public static Ingredient runeGluttony = Ingredient.of(BotaniaItems.runeGluttony);
    public static Ingredient runeGreed = Ingredient.of(BotaniaItems.runeGreed);
    public static Ingredient runeSloth = Ingredient.of(BotaniaItems.runeSloth);
    public static Ingredient runeWrath = Ingredient.of(BotaniaItems.runeWrath);
    public static Ingredient runeEnvy = Ingredient.of(BotaniaItems.runeEnvy);
    public static Ingredient runePride = Ingredient.of(BotaniaItems.runePride);
