...
public class BeamsRecipes {
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        BEAMS.recipeBuilder("naquadah_l" )//镎矿液
                ...
                .addData("mana",500000)
                .circuitMeta(1)
                .inputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:naquadah_oxide_mixture_dust")),1280)
        ...
        BEAMS.recipeBuilder("enriched_naquadah_l" )//富集镎矿液
                ...
                .addData("mana",2000000)
                .circuitMeta(1)
                .inputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:enriched_naquadah_oxide_mixture_dust")),1280)
        ...
        BEAMS.recipeBuilder("nqquadria" )//超频金液
                ...
                .circuitMeta(1)
                .inputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:naquadria_oxide_mixture_dust")),1280)
