...
public class ItemTags {
    ...
    public static void init(RegistrateTagsProvider<Item> provider) {
        create(provider, CMTags.ELEMENT_WATER, runeWater, runeSpring, runeWinter, runeSloth, runeEnvy, runeMana, STARLIGHT_RUNE.get(), QUASAR_RUNE.get(), PROLIFERATION_RUNE.get());
        create(provider, CMTags.ELEMENT_FIRE, runeFire, runeSummer, runeLust, runeWrath, runeMana, HORIZEN_RUNE.get(), STARLIGHT_RUNE.get(), TWIST_RUNE.get(), QUASAR_RUNE.get());
