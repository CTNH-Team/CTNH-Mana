...
import com.magicbee.ctnhmana.data.recipe.builder.bloodmagic.TartaricForgeRecipeBuilder;
...
public class HellForgeRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        smeltingHolder.applyAnointment(stack, AnointmentRegistrar.ANOINTMENT_SMELTING.get(),
                new AnointmentData(1, 1, 1));

        AnointmentHolder fortune1Holder = new AnointmentHolder();
        fortune1Holder.applyAnointment(stack, AnointmentRegistrar.ANOINTMENT_FORTUNE.get(),
                new AnointmentData(1, 1, 1));

        AnointmentHolder fortune2Holder = new AnointmentHolder();
        fortune2Holder.applyAnointment(stack, AnointmentRegistrar.ANOINTMENT_FORTUNE.get(),
                new AnointmentData(2, 1, 1));
        ...
        for (int i = 0; i < suffixArray.length; i++) {
            ...
            TartaricForgeRecipeBuilder.builder("shaped_charge" + suffixArray[i])
                    ...
                    .input(Ingredient.of(SHAPED_CHARGE_ITEM.get()), firstIngredientArray[i], secondIngredientArray[i],
                            thirdIngredientArray[i])
                    .output(shapedStack)
                    .save(provider);
            TartaricForgeRecipeBuilder.builder("deforester_charge" + suffixArray[i])
                    .minimumSouls(2).soulDrain(1)
                    .input(Ingredient.of(DEFORESTER_CHARGE_ITEM.get()), firstIngredientArray[i],
                            secondIngredientArray[i], thirdIngredientArray[i])
                    .output(deforesterStack)
                    .save(provider);
            TartaricForgeRecipeBuilder.builder("vein_charge" + suffixArray[i])
                    .minimumSouls(2).soulDrain(1)
                    .input(Ingredient.of(VEINMINE_CHARGE_ITEM.get()), firstIngredientArray[i], secondIngredientArray[i],
                            thirdIngredientArray[i])
                    .output(veinStack)
                    .save(provider);
            TartaricForgeRecipeBuilder.builder("fungal_charge" + suffixArray[i])
                    .minimumSouls(2).soulDrain(1)
                    .input(Ingredient.of(FUNGAL_CHARGE_ITEM.get()), firstIngredientArray[i], secondIngredientArray[i],
                            thirdIngredientArray[i])
                    .output(fungalStack)
                    .save(provider);
        }
        ...
        TartaricForgeRecipeBuilder.builder("amethyst_throwing_dagger")// 紫水晶飞刀
                .input(new ItemStack(AMETHYST_SHARD, 1).getItem(), new ItemStack(COPPER_INGOT, 1).getItem(),
                        new ItemStack(COPPER_INGOT, 1).getItem())
                .output(new ItemStack(
                        ForgeRegistries.ITEMS.getValue(new ResourceLocation("bloodmagic:amethystthrowingdagger")), 16))
        ...
        TartaricForgeRecipeBuilder.builder("field_restriction_casing")
                .input(Ingredient.of(new ItemStack(CASING_FORCE_FILED.get(), 8)),
                        Ingredient.of(ChemicalHelper.get(gear, GTMaterials.TungstenSteel)),
                        Ingredient.of(ENDSLATE.get()))
        ...
        TartaricForgeRecipeBuilder.builder("fused_demon_mixed_mana_dust")
                .input(Ingredient.of(ChemicalHelper.get(dust, Fused_Lp_Mixed_Mana)),
                        Ingredient.of(ETHEREAL_SLATE.get()))
        ...
        TartaricForgeRecipeBuilder.builder("raw_crystal1")
                .input(Ingredient.of(new ItemStack(AMETHYST_SHARD, 8)), Ingredient.of(ENDSLATE.get()),
                        Ingredient.of(CORROSIVE_CRYSTAL.get()))
