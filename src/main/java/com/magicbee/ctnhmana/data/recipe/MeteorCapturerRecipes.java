...
import static com.magicbee.ctnhmana.registry.CMRecipeTypes.*;
...
public class MeteorCapturerRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        METEOR_CAPTURER_RECIPES.recipeBuilder("palladium_platinum_cooperite_iridium_osmium_copper")
                ...
                .outputItems(
                        ForgeRegistries.ITEMS.getValue(new ResourceLocation("ctnhcore:mars_stone_palladium_ore_ore")),
                        64)
                .outputItems(
                        ForgeRegistries.ITEMS.getValue(new ResourceLocation("ctnhcore:mars_stone_platinum_ore_ore")),
                        256)
        ...
        METEOR_CAPTURER_RECIPES.recipeBuilder("palladium_platinum_cooperite_pentlandite_tetrahedrite")
                ...
                .inputFluids(FluidIngredient.of(BloodMagicFluids.LIFE_ESSENCE_FLUID.get(), 1000 * 1024))
                .outputItems(
                        ForgeRegistries.ITEMS.getValue(new ResourceLocation("ctnhcore:moon_stone_palladium_ore_ore")),
                        64)
                .outputItems(
                        ForgeRegistries.ITEMS.getValue(new ResourceLocation("ctnhcore:moon_stone_platinum_ore_ore")),
                        256)
                .outputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:moon_stone_cooperite_ore")),
                        128)
                .outputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:moon_stone_pentlandite_ore")),
                        64)
                .outputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:moon_stone_tetrahedrite_ore")),
                        64)
                .duration(400)
                .EUt(3072000 / 400)
                .save(provider);
        METEOR_CAPTURER_RECIPES.recipeBuilder("galena_sphalerite")
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:netherrack_sphalerite_ore")),
                        2560)
                .duration(400)
                .EUt(12288000 / 400)
                .save(provider);
        METEOR_CAPTURER_RECIPES.recipeBuilder("zenith_star")
                ...
                .chancedOutput(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:moon_stone_dust"))
                        .getDefaultInstance(), (int) 4000f, 64)
                .chancedOutput(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:moon_stone_dust"))
                        .getDefaultInstance(), (int) 4000f, 64)
                .chancedOutput(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:mar_stone_dust"))
                        .getDefaultInstance(), (int) 4000f, 64)
                .chancedOutput(ForgeRegistries.ITEMS.getValue(new ResourceLocation("gtceu:mar_stone_dust"))
                        .getDefaultInstance(), (int) 4000f, 64)
        ...
        METEOR_CAPTURER_RECIPES.recipeBuilder("aluminum_silicon_sulfur_phosphorus")
                ...
                .outputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ctnhcore:endstone_cryolite_ore")),
                        256)
        ...
        METEOR_CAPTURER_RECIPES.recipeBuilder("press")
                ...
                .inputFluids(FluidIngredient.of(BloodMagicFluids.LIFE_ESSENCE_FLUID.get(), 1000 * 256))
                .outputItems(ForgeRegistries.ITEMS.getValue(new ResourceLocation("ae2omnicells:omni_link_print_press")),
                        1)
                .outputItems(
                        ForgeRegistries.ITEMS.getValue(new ResourceLocation("ae2omnicells:complex_link_print_press")),
                        1)
                .outputItems(ForgeRegistries.ITEMS
                        .getValue(new ResourceLocation("ae2omnicells:multidimensional_expansion_print_press")), 1)
                .duration(400)
                .EUt(768000 / 400)
                .save(provider);
        ...
        METEOR_CAPTURER_RECIPES.recipeBuilder("naquadah_enriched_naquadria_oxide_mixture")
                ...
                .inputFluids(FluidIngredient.of(BloodMagicFluids.LIFE_ESSENCE_FLUID.get(), 1000 * 1024))
                .outputItems(
                        ForgeRegistries.ITEMS.getValue(new ResourceLocation("ctnhcore:naquadah_oxide_mixture_ore")),
                        512)
                .outputItems(ForgeRegistries.ITEMS
                        .getValue(new ResourceLocation("ctnhcore:enriched_naquadah_oxide_mixture_ore")), 128)
                .outputItems(
                        ForgeRegistries.ITEMS.getValue(new ResourceLocation("ctnhcore:naquadria_oxide_mixture_ore")),
                        32)
                .duration(400)
                .EUt(80000000 / 400)
                .save(provider);
