...
import static com.magicbee.ctnhmana.registry.CMRecipeTypes.BLOOD_ALTAR_RECIPES;
...
public class ManaCircuitRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        TerraPlateRecipeBuilder.builder("mana_integrated_circuit")// 魔力集成电路
                ...
                .input(ADVANCED_MANA_INDUCTOR.asStack())
                .input(ADVANCED_MANA_TRANSISTOR.asStack())
