...
/**
 * 物理拮抗：使携带者完全免疫物理、爆炸、弹射物等伤害。
 * 伤害免疫的具体判定见 {@link com.magicbee.ctnhmana.event.PhysicalAntagonismEventHandler}。
 * 1.20.1 原版不会把怪物的效果同步给客户端，因此这里周期性推送数据包，
 * 由客户端 {@link com.magicbee.ctnhmana.client.render.AntagonismRender} 在头顶渲染图标。
 */
public class PhysicalAntagonismEffect extends MobEffect {

    public PhysicalAntagonismEffect() {
        super(MobEffectCategory.BENEFICIAL, 0x8B8B83);
    }
