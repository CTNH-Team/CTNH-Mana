...
import com.magicbee.ctnhmana.client.render.DemonWillRender;
import com.magicbee.ctnhmana.common.multiblock.DemonWillMachine;
import com.magicbee.ctnhmana.common.multiblock.MeteorCaptureMachine;
...
import static com.magicbee.ctnhmana.common.multiblock.DemonWillMachine.SHIFT_TOOLTIPS;
import static com.magicbee.ctnhmana.registry.CMBlocks.CASING_BLOOD;
import static com.magicbee.ctnhmana.registry.CMBlocks.CASING_FORCE_FILED;

public class BloodMagic {

    public static void init() {}

    public final static MultiblockMachineDefinition DEMON_WILL_GENERATOR = REGISTRATE
            .multiblock("demon_will_generator", DemonWillMachine::new)
            .cnLangValue("恶魔意志发电机")
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    ...
                    .aisle("                                 ", "                                 ",
                            ...
                            "                                 ", "                                 ",
                            "      F                   F      ", "      C                   C      ",
                            "      I       JJJJJ       I      ", "  D  BKB  D           D  BKB  D  ",
                            "  C  GKG  C           C  GKG  C  ", " CE B K B EC         CE B K B EC ",
                            "BCE F K F ECB       BCE F K F ECB", "  C B K B C           C B K B C  ",
                            "  D  GKG  D           D  GKG  D  ", "     BKB                 BKB     ",
                            "      I                   Z      ", "      C                   C      ",
                            "      F                   F      ", "                                 ",
                            "                                 ", "                                 ",
                            "                                 ", "                                 ",
    ...
    public static final MultiblockMachineDefinition METEOR_CAPTURER = REGISTRATE
            .multiblock("meteor_capturer", MeteorCaptureMachine::new)
            .cnLangValue("§4坠星操纵者§r")
            .rotationState(RotationState.NON_Y_AXIS)
            .allowExtendedFacing(false)
            .allowFlip(false)
            .appearanceBlock(GTBlocks.CASING_STEEL_SOLID)
            .noRecipeModifier()
            .recipeType(CMRecipeTypes.METEOR_CAPTURER_RECIPES)
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("###########################", "###########################", "###########################",
                            "###########################", "###########################", "###########################",
                            "###########################", "###########################", "###########################",
                    ...
                    .aisle("###########################", "###########################", "###########################",
                            ...
                            "###########################", "###########################", "###########################")
                    .where("#", Predicates.any())
                    .where("B", Predicates.blocks(CASING_BLOOD.get()))
                    .where("C", Predicates.blocks(CASING_FORCE_FILED.get()))
                    .where('D', Predicates.blocks(CASING_BLOOD.get())
                    ...
                    .where("@", Predicates.controller(Predicates.blocks(definition.get())))
                    .build())
            .workableCasingModel(CTNHMana.id("block/casings/blood_casing"), GTCEu.id("block/machines/miner"))
            .register();
}
