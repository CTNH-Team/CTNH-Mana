...
import static com.magicbee.ctnhmana.registry.CMBlocks.LIVING_ROCK_CASING;
import static com.magicbee.ctnhmana.registry.CMMultiblockMachines.addManaMachineTooltips;
import static com.magicbee.ctnhmana.registry.CMMultiblockMachines.basemanamutiblockLang;
...
public class ZenithMachine {
    ...
    public final static MultiblockMachineDefinition ZENITH_CUTTER = REGISTRATE
            .multiblock("zenith_cutter",
                    holder -> new com.magicbee.ctnhmana.common.multiblock.ZenithMachine(holder, 24, 32))
    ...
    public final static MultiblockMachineDefinition ZENITH_ELECTROLYZER = REGISTRATE
            .multiblock("zenith_electrolyzer",
                    holder -> new com.magicbee.ctnhmana.common.multiblock.ZenithMachine(holder, 7, 32))
    ...
    public final static MultiblockMachineDefinition ZENITH_EXTRUDER = REGISTRATE
            .multiblock("zenith_extruder",
                    holder -> new com.magicbee.ctnhmana.common.multiblock.ZenithMachine(holder, 32, 32))
